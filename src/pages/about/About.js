            ...
            <div className={!openMenu ? `main-about ` : `hidden`}>
                ...
                <div className='w-full h-[80%] md:w-full md:h-[80%] lg:h-full   flex flex-col lg:justify-center  '>
                    <div className={`w-full  h-full md:h-full lg:h-[70%]  px-[50px] 2xl:px-[70px] flex flex-col md:justify-center lg:justify-normal items-center  2xl:justify-evenly lg:pt-[45px]`}>
                        ...
                        <p className={`w-full ${isXsScreen ? `leading-6 text-justify` : `leading-8 lg:leading-9 2xl:leading-10 text-center `}  font-roboto text-[1rem] lg:text-[1.2rem]  text-dark-900  scale-up-center`}>
                        ...
                        <button className=' p-2 lg:p-0 w-[150px]  lg:h-[50px] bg-[#3E2938] rounded-md mt-4 md:mt-6 font-roboto hover:bg-[#414B59] transition duration-700 ease-in-out hover:scale-105 scale-up-center' onClick={handleBtnClick}>
                            Contact Me
                        </button>
