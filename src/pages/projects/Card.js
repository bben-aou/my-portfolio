    ...
    return (
        <div className="w-[17rem]  lg:w-[17rem] lg:h-[20rem] max-w-xs overflow-hidden rounded-lg shadow-md bg-[#1e293b] hover:shadow-xl hover:scale-105 transition-shadow duration-300 ease-in-out mx-2 scale-up-center">
            ...
            <div className="p-5 pt-[0.4rem] flex flex-col items-center">
                ...
                <a href={githubPath} rel="noreferrer" target="_blank" className="w-[60%] inline-flex justify-center items-center px-3 py-2 lg:mt-1  text-sm font-medium text-center text-dark-900 bg-dark-800 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-light-900 dark:hover:bg-light-800 dark:focus:ring-light-800">
                    source code
